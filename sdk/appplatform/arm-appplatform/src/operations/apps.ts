...
export class Apps {
   ...
   */
  createOrUpdate(resourceGroupName: string, serviceName: string, appName: string, options?: Models.AppsCreateOrUpdateOptionalParams): Promise<Models.AppsCreateOrUpdateResponse> {
    return this.beginCreateOrUpdate(resourceGroupName,serviceName,appName,options)
   ...
   */
  update(resourceGroupName: string, serviceName: string, appName: string, options?: Models.AppsUpdateOptionalParams): Promise<Models.AppsUpdateResponse> {
    return this.beginUpdate(resourceGroupName,serviceName,appName,options)
   ...
   */
  beginCreateOrUpdate(resourceGroupName: string, serviceName: string, appName: string, options?: Models.AppsBeginCreateOrUpdateOptionalParams): Promise<msRestAzure.LROPoller> {
   ...
   * @returns Promise<msRestAzure.LROPoller>
   */
  beginUpdate(resourceGroupName: string, serviceName: string, appName: string, options?: Models.AppsBeginUpdateOptionalParams): Promise<msRestAzure.LROPoller> {
    return this.client.sendLRORequest(
      {
        resourceGroupName,
        serviceName,
