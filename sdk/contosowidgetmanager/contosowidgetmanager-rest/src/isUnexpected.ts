...
export function isUnexpected(
  response: DeleteWidget202Response | DeleteWidgetLogicalResponse | DeleteWidgetDefaultResponse,
): response is DeleteWidgetDefaultResponse;
export function isUnexpected(
  response: GetWidgetOperationStatus200Response | GetWidgetOperationStatusDefaultResponse,
