...
/**
 * Contains response data for the listByResourceGroupXX operation.
 */
export type ProfilesListByResourceGroupXXResponse = ProfileListResult & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
...
/**
 * Contains response data for the listByResourceGroupXXNext operation.
 */
export type ProfilesListByResourceGroupXXNextResponse = ProfileListResult & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
