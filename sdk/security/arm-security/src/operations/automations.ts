...
export class Automations {
  ...
  /**
   * Create or update a security automation. If a security automation is already created and a
   * subsequent create request is issued with different properties, the security automation
  ...
  /**
   * Validate the security automation model before create or update. Any validation errors are
