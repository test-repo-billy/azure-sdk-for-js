...
export const AutomationActionSecurityEmail: msRest.CompositeMapper = {
  serializedName: "SecurityEmail",
  type: {
    name: "Composite",
    polymorphicDiscriminator: AutomationAction.type.polymorphicDiscriminator,
    uberParent: "AutomationAction",
    className: "AutomationActionSecurityEmail",
    modelProperties: {
      ...AutomationAction.type.modelProperties,
      subscriptionRbacRoles: {
        serializedName: "subscriptionRbacRoles",
        type: {
          name: "Sequence",
          element: {
            type: {
...
export const discriminators = {
  ...
  'AutomationAction.SecurityEmail' : AutomationActionSecurityEmail,
