...
export class VpnServerConfigurations {
  ...
  updateTags(resourceGroupName: string, vpnServerConfigurationName: string, vpnServerConfigurationParameters: Models.TagsObject, options?: msRest.RequestOptionsBase): Promise<Models.VpnServerConfigurationsUpdateTagsResponse> {
    return this.beginUpdateTags(resourceGroupName,vpnServerConfigurationName,vpnServerConfigurationParameters,options)
      .then(lroPoller => lroPoller.pollUntilFinished()) as Promise<Models.VpnServerConfigurationsUpdateTagsResponse>;
  }
   ...
   * @returns Promise<msRestAzure.LROPoller>
   */
  beginUpdateTags(resourceGroupName: string, vpnServerConfigurationName: string, vpnServerConfigurationParameters: Models.TagsObject, options?: msRest.RequestOptionsBase): Promise<msRestAzure.LROPoller> {
    return this.client.sendLRORequest(
      {
        resourceGroupName,
        vpnServerConfigurationName,
