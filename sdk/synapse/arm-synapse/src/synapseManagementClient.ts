...
class SynapseManagementClient extends SynapseManagementClientContext {
  ...
  workspaceManagedqlServerBlobAuditingPolicies: operations.WorkspaceManagedqlServerBlobAuditingPolicies;
  ...
  constructor(credentials: msRest.ServiceClientCredentials, subscriptionId: string, options?: Models.SynapseManagementClientOptions) {
    ...
    this.workspaceManagedqlServerBlobAuditingPolicies = new operations.WorkspaceManagedqlServerBlobAuditingPolicies(this);
