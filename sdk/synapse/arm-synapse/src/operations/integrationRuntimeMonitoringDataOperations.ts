...
import * as Mappers from "../models/integrationRuntimeMonitoringDataOperationsMappers";
import * as Parameters from "../models/parameters";
import { SynapseManagementClientContext } from "../synapseManagementClientContext";

/** Class representing a IntegrationRuntimeMonitoringDataOperations. */
export class IntegrationRuntimeMonitoringDataOperations {
  private readonly client: SynapseManagementClientContext;

  /**
   * Create a IntegrationRuntimeMonitoringDataOperations.
