...
export interface LibraryResource extends SubResource {
   ...
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
  readonly libraryResourceName?: string;
  /**
   ...
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
  readonly libraryResourceType?: string;
  /**
...
/**
 * @interface
 * Collection of libraries information
 * @summary Collection of libraries
