...
export const RecommendationsGabABDAateHeaders: msRest.CompositeMapper = {
  serializedName: "recommendations-gababdaate-headers",
  type: {
    name: "Composite",
    className: "RecommendationsGabABDAateHeaders",
    modelProperties: {
      location: {
