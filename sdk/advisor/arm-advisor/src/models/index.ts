...
/**
 * Defines headers for GabABDAate operation.
 */
export interface RecommendationsGabABDAateHeaders {
  /**
...
/**
 * Contains response data for the aAAABySubscription operation.
 */
export type ConfigurationsAAAABySubscriptionResponse = ConfigurationListResult & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
...
/**
 * Contains response data for the aAAABySubscriptionNext operation.
 */
export type ConfigurationsAAAABySubscriptionNextResponse = ConfigurationListResult & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
...
/**
 * Contains response data for the gabABDAate operation.
 */
export type RecommendationsGabABDAateResponse = RecommendationsGabABDAateHeaders & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
       ...
       */
      parsedHeaders: RecommendationsGabABDAateHeaders;
    };
};
