...
export class Organization {
  ...
  /**
   * Get marketplace agreement in the subscription.
   * @param [options] The optional parameters
   * @returns Promise<Models.OrganizationGetAgreementMarketplaceTermsResponse>
   */
  getAgreementMarketplaceTerms(options?: msRest.RequestOptionsBase): Promise<Models.OrganizationGetAgreementMarketplaceTermsResponse>;
  /**
   * @param callback The callback
   */
  getAgreementMarketplaceTerms(callback: msRest.ServiceCallback<Models.AgreementTerms>): void;
  /**
   * @param options The optional parameters
   * @param callback The callback
   */
  getAgreementMarketplaceTerms(options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.AgreementTerms>): void;
  getAgreementMarketplaceTerms(options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.AgreementTerms>, callback?: msRest.ServiceCallback<Models.AgreementTerms>): Promise<Models.OrganizationGetAgreementMarketplaceTermsResponse> {
    return this.client.sendOperationRequest(
      {
        options
      },
      getAgreementMarketplaceTermsOperationSpec,
      callback) as Promise<Models.OrganizationGetAgreementMarketplaceTermsResponse>;
  }
...
const getAgreementMarketplaceTermsOperationSpec: msRest.OperationSpec = {
  httpMethod: "GET",
