...
<html lang="en">
  <head>
    <title>@azure/arm-storagecache sample</title>
    <script src="node_modules/@azure/ms-rest-js/dist/msRest.browser.js"></script>
    <script src="node_modules/@azure/ms-rest-azure-js/dist/msRestAzure.js"></script>
    <script src="node_modules/@azure/ms-rest-browserauth/dist/msAuth.js"></script>
    <script src="node_modules/@azure/arm-storagecache/dist/arm-storagecache.js"></script>
    <script type="text/javascript">
      ...
      authManager.finalizeLogin().then((res) => {
        ...
        const client = new Azure.ArmStoragecache.StorageCacheManagementClient(res.creds, subscriptionId);
        client.operations.list().then((result) => {
          console.log("The result is:");
          console.log(result);
        }).catch((err) => {
...
![Impressions](https://azure-sdk-impressions.azurewebsites.net/api/impressions/azure-sdk-for-js/sdk/storagecache/arm-storagecache/README.png)
