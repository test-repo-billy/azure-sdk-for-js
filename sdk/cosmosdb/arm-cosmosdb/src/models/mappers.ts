...
export const SqlTriggerGetResults: msRest.CompositeMapper = {
  ...
  type: {
    ...
    modelProperties: {
      ...
      triggerOperation: {
        serializedName: "properties.triggerOperation",
        type: {
          name: "String"
        }
      },
