...
## 23.0.0-beta.1 (2025-02-11)
Compared with version 22.3.0
    
### Features Added

  - Added operation group AttributeBasedVMSizeRecommender
  ...
  - Added operation group SpotPlacementRecommender
  - Added operation group SpotPlacementScores
  - Added Interface AttributeBasedVMSizeRecommenderInput
  - Added Interface AttributeBasedVMSizeRecommenderPostOptionalParams
  - Added Interface AttributeBasedVMSizeRecommenderResponse
  - Added Interface ComputeDiagnosticBase
  - Added Interface ComputeDiagnosticsList
  - Added Interface ComputeDiagnosticsOperationResult
  - Added Interface DiagnosticOperationsReadHeaders
  ...
  - Added Interface DiskInspectionCreateHeaders
  ...
  - Added Interface RecommendedVMSizeAttributes
  - Added Interface RecommendedVMSizeProperties
  - Added Interface RecommendedVMSizeRestrictions
  - Added Interface RecommendedVMSizes
  - Added Interface RegularPriorityProfile
  ...
  - Added Interface SpotPlacementRecommenderGetOptionalParams
  - Added Interface SpotPlacementRecommenderInput
  - Added Interface SpotPlacementRecommenderPostOptionalParams
  - Added Interface SpotPlacementRecommenderResponse
  ...
  - Added Interface SpotPriorityProfile
  ...
  - Added Interface VMSizeOfferRestriction
  - Added Interface VMSizeOfferRestrictionInfo
  - Added Interface VMSizeQuotaRestriction
  - Added Type Alias AttributeBasedVMSizeRecommenderPostResponse
  - Added Type Alias CreatedByType
  - Added Type Alias DiagnosticOperationsReadResponse
  ...
  - Added Type Alias QuotaRestrictionsType
  - Added Type Alias ResourceSkuRestrictionReasonCode
  - Added Type Alias ResourceSkuRestrictionType
  - Added Type Alias RestrictionsFilterType
  - Added Type Alias ResultStatus
  - Added Type Alias SpotPlacementRecommenderGetResponse
  - Added Type Alias SpotPlacementRecommenderPostResponse
...
### Breaking Changes
  ...
  - Type of parameter systemData of interface CloudService is changed from SystemData to SystemDataAutoGenerated
