...
export class PolicyMetadataOperations {
   ...
   */
  list(options?: msRest.RequestOptionsBase): Promise<Models.PolicyMetadataListResponse>;
  /**
   * @param callback The callback
   */
   ...
   * @param callback The callback
   */
  list(options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.PolicyMetadataCollection>): void;
  list(options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.PolicyMetadataCollection>, callback?: msRest.ServiceCallback<Models.PolicyMetadataCollection>): Promise<Models.PolicyMetadataListResponse> {
    return this.client.sendOperationRequest(
      {
        options
      },
