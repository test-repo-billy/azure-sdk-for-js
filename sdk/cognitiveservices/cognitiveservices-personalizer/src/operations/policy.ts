...
export class Policy {
  ...
  /**
   * Get the current policy configuration of the Personalizer service.
   * @summary Get Policy.
  ...
  /**
   * Update the current policy configuration of the Personalizer service.
  ...
  /**
   * Resets the current policy configuration of the Personalizer service to default.
   * @summary Delete Policy.
   * @param [options] The optional parameters
   * @returns Promise<Models.PolicyDeleteMethodResponse>
   */
  deleteMethod(options?: msRest.RequestOptionsBase): Promise<Models.PolicyDeleteMethodResponse>;
  /**
   * @param callback The callback
   */
  deleteMethod(callback: msRest.ServiceCallback<Models.PolicyContract>): void;
  /**
   * @param options The optional parameters
   * @param callback The callback
   */
  deleteMethod(options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.PolicyContract>): void;
  deleteMethod(options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.PolicyContract>, callback?: msRest.ServiceCallback<Models.PolicyContract>): Promise<Models.PolicyDeleteMethodResponse> {
    return this.client.sendOperationRequest(
      {
        options
      },
      deleteMethodOperationSpec,
      callback) as Promise<Models.PolicyDeleteMethodResponse>;
  }
}
