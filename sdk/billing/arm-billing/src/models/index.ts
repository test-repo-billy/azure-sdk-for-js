...
export interface Policy extends Resource {
   ...
   * 'AllAllowed', 'FreeAllowed', 'NotAllowed'
   */
  ...
  /**
   * Who can view charges. Possible values include: 'None', 'SubscriptionOwner'
   */
 ...
 * @enum {string}
 */
export type AgreementType = 'MicrosoftCustomerAgreement' | 'EnterpriseAgreement' | 'MicrosoftOnlineServicesProgram';
 ...
 * Possible values include: 'AllAllowed', 'FreeAllowed', 'NotAllowed'
 * @readonly
 * @enum {string}
 */
export type MarketplacePurchasesPolicy = 'AllAllowed' | 'FreeAllowed' | 'NotAllowed';
 ...
 * Possible values include: 'None', 'SubscriptionOwner'
 * @readonly
 * @enum {string}
 */
export type ViewChargesPolicy = 'None' | 'SubscriptionOwner';
