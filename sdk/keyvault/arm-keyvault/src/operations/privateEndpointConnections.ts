...
export class PrivateEndpointConnections {
   ...
   * @param resourceGroupName The name of the resource group that contains the key vault.
   ...
   * @param callback The callback
   */
  deleteMethod(resourceGroupName: string, vaultName: string, privateEndpointConnectionName: string, callback: msRest.ServiceCallback<void>): void;
  /**
   * @param resourceGroupName The name of the resource group that contains the key vault.
   * @param vaultName The name of the key vault.
   * @param privateEndpointConnectionName The name of the private endpoint connection associated with
   ...
   * @param callback The callback
   */
  deleteMethod(resourceGroupName: string, vaultName: string, privateEndpointConnectionName: string, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<void>): void;
  deleteMethod(resourceGroupName: string, vaultName: string, privateEndpointConnectionName: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<void>, callback?: msRest.ServiceCallback<void>): Promise<Models.PrivateEndpointConnectionsDeleteResponse> {
    return this.client.sendOperationRequest(
      {
        resourceGroupName,
        vaultName,
      ...
      callback) as Promise<Models.PrivateEndpointConnectionsDeleteResponse>;
  }
}
