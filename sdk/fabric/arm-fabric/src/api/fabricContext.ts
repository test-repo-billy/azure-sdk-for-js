...
export function createFabric(
  ...
  const userAgentInfo = `azsdk-js-arm-fabric/1.0.0-beta.1`;
  ...
  const apiVersion = options.apiVersion ?? "2025-01-15-preview";
  ...
  return { ...clientContext, apiVersion, subscriptionId } as FabricContext;
}
